...
<div class="box_task" id="Box_Tools_3">
  ...
  <div class="box_cont">
    ...
    <div class="task_cont">
      <h2><!--a onclick="getTaskAll();">查看当前任务</a-->
...
<img width="18" style="position: absolute; top: 345px; z-index: 100; left: 975px; cursor: pointer;" src="../new_images/ui/rfrpg2.png" onclick="$('gw').contentWindow.location.reload()" title="刷新框内页面">
</body>
</html>
<script type="text/javascript">
