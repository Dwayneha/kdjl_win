...
function taskCatchss(tid, n, t)
{
	...
	{
		window.parent.UnTip();
		var robj = event.srcElement;
		try{
			if (robj.id.indexOf('t')==0)
			{
	...
	M_X=ev.clientX + document.body.scrollLeft - document.body.clientLeft,
	M_Y=ev.clientY + document.body.scrollTop     - document.body.clientTop
	}*/
