...
define('ADMIN_USERNAME','leinchu'); 	// Admin Username
define('ADMIN_PASSWORD','123qweASD');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);
$_mem['host']		=	'192.168.0.109';
$_mem['port']		=	'11212';
$MEMCACHE_SERVERS[] = '192.168.0.109:11212'; // add more as an array

////////// END OF DEFAULT CONFIG AREA /////////////////////////////////////////////////////////////
$ip=get_real_ip();
if($ip=='125.69.81.43'||$ip=='58.215.75.179')
{
