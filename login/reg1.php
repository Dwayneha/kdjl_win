...
if(gh!=''){
		var opt = {
			...
			onSuccess: function(t) {
				...
				if(n == '不好意思，可能是您太倒霉了，没有得到任何奖励！'){
					$('ghtips').innerHTML='激活成功！';
				}
				if(n != '' && n != '不好意思，可能是您太倒霉了，没有得到任何奖励！'){
					$('ghtips').innerHTML=n;
					return false;
				}
			},
...
<table width="968">
  ...
  <tr>
    ...
    <td class="sb"><div style="position:absolute; top:540px;" class="sbb">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  用户名：<input type="text" style="width:80px;" class="username" name="username"  id="username"  />
	  密码：<input type="password" style="width:80px;" class="pass" name="pass"  id="pass"  />
	   角色名： <input type="text" style="width:80px;" class="bname" name="bname"  id="bname"  />
